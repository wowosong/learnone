...
- **初始化**：对类的静态变量初始化为指定的值，执行静态代码块    ![0](d:\pic-md/20220115123315.png)
...
## **Tomcat自定义加载器详解**    ![0](d:\pic-md/20220115153942.png)
