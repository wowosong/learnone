...
- minus(except) 相减(差集)
  ...
  ![image-20211210055812586](d:\pic-md/20211210055812.png)
...
![image-20211210060234838](d:\pic-md/20211210060234.png)
...
![图片](d:\pic-md/20210812205839.png)
...
![image-20211210055957222](d:\pic-md/20211210055957.png)
...
![image-20211210060447840](d:\pic-md/20211210060447.png)
...
![image-20211210060510323](d:\pic-md/20211210060510.png)

学生表的“学号”列设置为主键约束，下图是每一列设置的数据类型和约束

![image-20211210060533773](d:\pic-md/20211210060533.png)

创建完表，点击“保存”

![image-20211210060556253](d:\pic-md/20211210060556.png)

##### 2）创建成绩表（score）

同样的步骤，创建"成绩表“。“课程表的“学号”和“课程号”一起设置为主键约束（联合主键），“成绩”这一列设置为数值类型（float，浮点数值）

![image-20211210060620715](d:\pic-md/20211210060620.png)

##### 3）创建课程表（course）

课程表的“课程号”设置为主键约束

![image-20211210060638819](d:\pic-md/20211210060638.png)

##### 4）教师表（teacher）

教师表的“教师号”列设置为主键约束，教师姓名这一列设置约束为“null”（红框的地方不勾选），表示这一列允许包含空值（null）。

![image-20211210060837385](d:\pic-md/20211210060837.png)

向表中添加数据

![image-20211210060903754](d:\pic-md/20211210060903.png)
...
![image-20211210060942905](d:\pic-md/20211210060942.png)

![image-20211210061013427](d:\pic-md/20211210061013.png)

![image-20211210061028831](d:\pic-md/20211210061028.png)
...
![image-20211210061049780](d:\pic-md/20211210061049.png)
...
![image-20211210061123334](d:\pic-md/20211210061123.png)
...
![image-20211210061214984](d:\pic-md/20211210061215.png)

添加结果

![image-20211210061240467](d:\pic-md/20211210061240.png)

### 三、50道面试题

为了方便学习，我将50道面试题进行了分类

![image-20211210061729744](d:\pic-md/20211210061729.png)

查询姓“猴”的学生名单

![image-20211210065106731](d:\pic-md/20211210065106.png)
...
![image-20211210065047782](d:\pic-md/20211210065047.png)
...
![image-20211210065019371](d:\pic-md/20211210065019.png)
...
![image-20211210064957807](d:\pic-md/20211210064957.png)
...
![image-20211210064328450](d:\pic-md/20211210064328.png)
...
![image-20211210063801491](d:\pic-md/20211210063801.png)
