...
# 05、Web开发
  ...
  ![image-20220119213526203](d:\pic-md/202201200938192.png)
...
![image.png](d:\pic-md/202201200940418.png)
...
![image.png](d:\pic-md/202201200941692.png)


RequestMappingHandlerMapping：保存了所有@RequestMapping 和handler的映射规则。  

![image.png](d:\pic-md/202201200941040.png)
...
![image.png](d:\pic-md/202201200941981.png)

  

![image.png](d:\pic-md/202201200941453.png)

  

![image.png](d:\pic-md/202201200941939.png)
...
![image.png](d:\pic-md/202201200941891.png)
...
![image.png](d:\pic-md/202201200942230.png)

  

![image.png](d:\pic-md/202201200942413.png)
...
![image.png](d:\pic-md/202201200942621.png)
...
![image.png](d:\pic-md/202201200942133.png)

  

  

![image.png](d:\pic-md/202201200943418.png)
...
![image.png](d:\pic-md/202201200943084.png)
...
![image-20220119215420334](d:\pic-md/20220119215420.png)
...
![image.png](d:\pic-md/202201200943407.png)
...
![image.png](d:\pic-md/202201200943914.png)
...
![image.png](d:\pic-md/202201200944654.png)
...
![image.png](d:\pic-md/202201200944798.png)
...
![image.png](d:\pic-md/202201200944659.png)
...
![image.png](d:\pic-md/202201200944428.png)
...
![image.png](d:\pic-md/202201200945704.png)
...
![image.png](d:\pic-md/202201200945302.png)
...
![image.png](d:\pic-md/202201200945622.png)

确定客户端接收什么样的内容类型； 
1、Parameter策略优先确定是要返回json数据（获取请求头中的format的值）  

![image.png](d:\pic-md/202201200945660.png)
...
![image.png](d:\pic-md/202201200945972.png)


​	○HeaderContentNegotiationStrategy 确定客户端可以接收的内容类型  

![image.png](d:\pic-md/202201200945996.png)

●3、遍历循环所有当前系统的 MessageConverter，看谁支持操作这个对象（Person） 
●4、找到支持操作Person的converter，把converter支持的媒体类型统计出来。 
●5、客户端需要【application/xml】。服务端能力【10种、json、xml】 
 ![image.png](d:\pic-md/202201200945999.png)   

 ●6、进行内容协商的最佳匹配媒体类型 
●7、用 支持 将对象转为 最佳匹配媒体类型 的converter。调用它进行转化 。  

![image.png](d:\pic-md/202201200946149.png)
...
![image.png](d:\pic-md/202201200946998.png)

  


![image.png](d:\pic-md/202201200946797.png)
...
![image-20220119220340613](d:\pic-md/202201200947306.png)
...
![image.png](d:\pic-md/202201200947696.png)

  

![image.png](d:\pic-md/202201200947085.png)

  


![image.png](d:\pic-md/202201200948046.png)


![image.png](d:\pic-md/202201200948599.png)
...
![image.png](d:\pic-md/202201200948830.png)
...
![image.png](d:\pic-md/202201200949124.png)

  


![image.png](d:\pic-md/202201200949060.png)
...
![image.png](d:\pic-md/202201200950652.png)
...
![image.png](d:\pic-md/202201200950284.png)

![image.png](d:\pic-md/202201200950020.png)

●要对其进行自定义，添加View解析为error 
●要完全替换默认行为，可以实现 ErrorController 并注册该类型的Bean定义，或添加ErrorAttributes类型的组件以使用现有机制但替换其内容。 
●error/下的4xx，5xx页面会被自动解析；  

![image.png](d:\pic-md/202201200950185.png)
...
![image.png](d:\pic-md/202201200950628.png)


●自定义实现 HandlerExceptionResolver 处理异常；可以作为默认的全局异常处理规则  

![image.png](d:\pic-md/202201200950259.png)
...
![image.png](d:\pic-md/202201200950323.png)




![image.png](d:\pic-md/202201200951525.png)
...
![image.png](d:\pic-md/202201200951594.png)

写出去json  
 ![image.png](d:\pic-md/202201200951035.png)
...
![image.png](d:\pic-md/202201200951949.png)


●2、系统默认的 异常解析器；  

![image.png](d:\pic-md/202201200951925.png)
...
![image.png](d:\pic-md/202201200951403.png)
...
![image.png](d:\pic-md/202201200952831.png)
...
![image.png](d:\pic-md/202201200952773.png)
