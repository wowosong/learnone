...
![](d:\pic-md/1641959321-60102bd7407aa3a8bf402d9dccdd58eb.png)

点击1处的蓝色箭头，即可运行当前测试类中的所有用例，即2个测试方法，运行效果如下，左边显示了运行的测试用例列表，右边的显示了输出信息。

![](d:\pic-md/1641959321-818d40b79c8b60bf9dd361156ff30419.png)

图中的2和3也可以点击，只会运行选中的那个测试方法，比如点击2，只会运行nameTest()这个用例，效果如下

![](d:\pic-md/1641959321-dec3067edd095baa3fec09c7d7e91af5.png)
