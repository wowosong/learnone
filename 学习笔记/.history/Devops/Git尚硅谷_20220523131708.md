...
![img](d:\pic-md/20220122132842.png) 

**分布式版本控制工具：**(每个用户机,也都有版本历史)意味可以本地库传本地不建议这么做**

**Git**、Mercurial、Bazaar、Darcs……

![image-20220122135538422](d:\pic-md/20220122135538.png)

## **3 Git** **简介** 

### 3.1、Git 简史

  ![img](d:\pic-md/20220122132904.jpg)
...
![img](d:\pic-md/20220122132914.jpg) 
...
(linux直接yum install -y git),加-y自动选择y，全自动
 ...
 ![img](d:\pic-md/20220122132923.jpg)

2下面默认设置就行:下图(下一步) **3**这个的下一步也使用默认 直接下一步

![img](d:\pic-md/20220122132929.jpg) 

 

**4** **选择默认的文本编辑器**

![img](d:\pic-md/20220122132935.jpg) 

**5** 然后修改环境变量(选第一完全不修改),下面选项第二个(是被认为安全的)

![image-20220122140125722](d:\pic-md/20220122140125.png)

**6** 选择客服端**本地库和远程库连接方式**(1通用连接2使用Windows连接方式)

![img](d:\pic-md/20220122132950.jpg) 
...
![img](d:\pic-md/20220122133003.jpg) 
...
![img](d:\pic-md/20220122133009.jpg) 

 

**10** 

![img](d:\pic-md/20220122133015.jpg) 

**11** (1加载他的git Bash终端2查看更新的文档)

![image-20220122135501717](d:\pic-md/20220122135501.png)

### 3.5、Git 结构 

![img](d:\pic-md/20220122133036.jpg) 
...
![img](d:\pic-md/20220122133043.jpg) 

**3.7.2** **跨团队协作** **p9**

![img](d:\pic-md/20220122133049.jpg) 
...
![img](d:\pic-md/20220122133056.jpg) 
...
![img](d:\pic-md/20220122133103.jpg) 
...
![img](d:\pic-md/20220122133109.jpg) 
...
![img](d:\pic-md/20220122133118.png) 
...
每个历史只显示一行(hash值和日志)
 ...
 ![img](d:\pic-md/20220122133128.png)
...
每个历史只显示一行且显示hash的部分值
 ...
 ![img](d:\pic-md/20220122133137.png)
...
显示历史只显示一行，并且显示指针(要移动到版本多少步)
 ...
 ![img](d:\pic-md/20220122133146.png)
...
**本质:指针移动**
  ...
  ![img](d:\pic-md/20220122133152.jpg)
...
![img](d:\pic-md/20220122133201.jpg) 
...
![img](d:\pic-md/20220122133207.jpg) 
...
![img](d:\pic-md/20220122133216.jpg) 
...
​	**冲突的表现：**
   ...
   ![img](d:\pic-md/20220122133225.jpg)
...
![img](d:\pic-md/20220122133232.jpg) 
...
哈希算法可以被用来验证文件。原理如下图所示：(传输前后hash值对比)
 ...
 ![img](d:\pic-md/20220122133238.jpg)
...
以文件变更列表的方式存储信息。这类系统将它们保存的信息看作是一组基本文件和每个文件随时间逐步累积的差异。SVN
 ...
 ![img](d:\pic-md/20220122133245.png)
...
![img](d:\pic-md/20220122133254.png) 

#### 5.2.3 Git 文件管理机制细节

Git 的“提交对象” (每个文件对应的hash值)

![img](d:\pic-md/20220122133301.jpg) 

提交对象及其父对象形成的链条

![img](d:\pic-md/20220122133307.jpg) 
...
#### 5.3.1 分支的创建(就是新建一个指针)
 ...
 ![img](d:\pic-md/20220122133315.jpg)

#### 5.3.2 分支的切换 (HEAD指向) 

![image-20220122133401670](d:\pic-md/20220122133401.png)

 

#### 5.3.3 HEAD指向testing时提交了内容

 ![img](d:\pic-md/20220122133437.jpg)

#### 5.3.4 切换回 master

  ![img](d:\pic-md/20220122133443.jpg)

 

#### 5.3.5  HEAD指向master时 提交了数据

  ![img](d:\pic-md/20220122133449.jpg)
...
| ![img](d:\pic-md/20220122133458.jpg) | Email 地址：atguigu2018ybuq@aliyun.comGitHub 账号：atguigu2018ybuq |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![img](d:\pic-md/20220122133506.jpg) | Email 地址：atguigu2018lhuc@aliyun.comGitHub 账号：atguigu2018lhuc |
| ![img](d:\pic-md/20220122133516.jpg) | Email 地址：atguigu2018east@aliyun.comGitHub 账号：atguigu2018east |



### 6.2、创建远程库 

![img](d:\pic-md/20220122133526.png) 

![image-20220122140251381](d:\pic-md/20220122140251.png)

### 6.3、创建远程库地址别名 

![img](d:\pic-md/20220122133541.jpg) 

**`git remote -v`**  查看当前所有远程地址别名 

**`git remote add [别名] [远程地址]`**  添加远程地址

![img](d:\pic-md/20220122133547.png) 
...
**`git push [别名] [分支名]`**  git push origin master  ( 回车可能需要等待一会会，弹出对话框 > 输入用户和密码 )
  ...
  ![img](d:\pic-md/20220122133556.png)
...
![img](d:\pic-md/20220122133606.jpg) 

成功:

![img](d:\pic-md/20220122133613.jpg) 
...
### 6.6、团队成员邀请(邀请用户才能提交)
 ...
 ![img](d:\pic-md/20220122133619.jpg)

**和老师笔记不一样的地方**

![img](d:\pic-md/20220122133628.jpg) 

 

![img](d:\pic-md/20220122133635.jpg) 

“岳不群”其他方式**把邀请链接发送给“令狐冲”，“**令狐冲”**登录自己的** **GitHub** **账号，**访问邀请链接。

点击接受 >然后在执行推送

![img](d:\pic-md/20220122133642.png) 

:推送了第一次在此推送不要输入用户名:git 本身不具备记录功能,Windows中**凭据管理器**记录用户名和密码

**控制面板\所有控制面板项\凭据管理器**(如果想切换用户:删除记录)**

![img](d:\pic-md/20220122133652.jpg) 
...
**1(**先复制**当前库地址**,发式给dfbb,然后有**dfbb登录**访问这个地址)>然后**Fork** 
  ...
  ![img](d:\pic-md/20220122133709.jpg)

![img](d:\pic-md/20220122133715.jpg)正在fork的界面

fork 过来的仓库说明 回多下面一行(forked from at...)说明fork来源

![img](d:\pic-md/20220122133721.jpg) 

2 dfbb(”东方不败”)本地修改，然后推送到远程 git push origin master

**3** dfbb在远程库中选择Pull Request

![img](d:\pic-md/20220122133727.jpg) 

![img](d:\pic-md/20220122133739.jpg)3.2然后点击里面的New pull requset

![img](d:\pic-md/20220122133743.jpg)3.3 然后点击 Create pull request

 3.4 然后发送消息给,fork的库(ybq(岳不群))

![img](d:\pic-md/20220122133749.jpg) 

**4** ybq操作

![img](d:\pic-md/20220122133758.jpg) 

**5**![img](d:\pic-md/20220122133805.jpg)

**5.2**对话** **(这时还可以相互对话)**

![img](d:\pic-md/20220122133812.jpg) 

![img](d:\pic-md/20220122133822.png) 

**6** **审核代码**

![img](d:\pic-md/20220122133830.jpg) 

**合并代码** **(回到对话Conversation>>合并操作如图)**

 

![img](d:\pic-md/20220122133837.jpg) 

 

![img](d:\pic-md/20220122133842.jpg) 

![img](d:\pic-md/20220122133847.jpg) 
...
**工程→右键→Team→Share Project→Git**
 ...
 ![img](d:\pic-md/20220122133858.jpg)

2 Create Repository

![img](d:\pic-md/20220122133906.jpg) 
...
![img](d:\pic-md/20220122133912.jpg) 

**2 设置用户email** 

![img](d:\pic-md/20220122133918.jpg) 

**Eclipse查看git文件标识说明: window>prefer.>Team>Git>Label D..  p46**

![img](d:\pic-md/20220122133924.jpg) 

**Eclipse:文件追踪添加到缓存区:**文件/项目> **右键>>Team>Commit**  **p47**

![img](d:\pic-md/20220122133931.jpg) 

**Eclipse**查看项目中的所有文件的**Navigator窗口打开**

![img](d:\pic-md/20220122133939.jpg) 
...
![img](d:\pic-md/20220122133948.jpg) 
...
![img](d:\pic-md/20220122133954.jpg) 

### **7.3**推送到远程库** **p50 (:在GitHub创建新的远程库,名为TestGit)**

![image-20220122140339311](d:\pic-md/20220122140339.png)

URI: 粘贴在GitHub复制的地址,后面2个默认;User账号,下面:密码

![img](d:\pic-md/20220122134008.jpg) 

点击Add All Bran... > 然后下一步/或者直接Finish

![img](d:\pic-md/20220122134014.jpg) 

可以添加一些日志信息>Finish

![image-20220122140403391](d:\pic-md/20220122140403.png)

执行成功的结果

![image-20220122140426840](d:\pic-md/20220122140427.png)

### **7.4Oxygen Eclipse** 克隆工程操作 **p51**

**1** **Import...导入工程**

![img](d:\pic-md/20220122134821.jpg) 

![img](d:\pic-md/20220122134828.png) 

**2** **到远程库复制工程地址**

![img](d:\pic-md/20220122134037.jpg) 

**3粘贴到URL  如下: >然后点击next**

 ![image-20220122140446873](d:\pic-md/20220122140447.png)
...
![image-20220122140512609](d:\pic-md/20220122140512.png)

**5**指定工程的保存位置**(最好选择eclipse工作区) 然后next**

![img](d:\pic-md/20220122134101.jpg) 

等待下载

6指定工程导入方式，**这里只能用：Import as general project** **(作为普通工程导入)**

![img](d:\pic-md/20220122134111.jpg) 

**7** 点击Finish

![img](d:\pic-md/20220122134118.jpg) 

 

**8** **转换工程类型 (导入进来的不适合编写.需要修改Eclipse工程)**

![img](d:\pic-md/20220122134124.jpg) 

**9**最终效果** 

![img](d:\pic-md/20220122134134.jpg) 
...
![img](d:\pic-md/20220122134141.png) 

正确做法：**保存到工作区以外的目录中**,其他的和上面都一样**

![img](d:\pic-md/20220122134146.jpg) 
...
4**这时TestGit2不能推送**,会出现这个图![img](d:\pic-md/20220122134158.jpg),因为不是最新版本,
...
![img](d:\pic-md/20220122134204.jpg) 
...
![img](d:\pic-md/20220122134211.jpg)**8.2.2 GitFlow 工作流**(最金典,用得最多)**

Gitflow 工作流通过为**功能开发**、**发布准备**和**维护设立**了**独立的分支**，让发布迭代过程更流畅。严格的分支模型也为大型项目提供了一些非常必要的结构。

![img](d:\pic-md/20220122134218.jpg) 
...
![img](d:\pic-md/20220122134224.jpg) 
...
![img](d:\pic-md/20220122134233.jpg) 

**8.3.3 分支实战** **p55**

![img](d:\pic-md/20220122134240.jpg) 
...
![img](d:\pic-md/20220122134246.jpg) 

**2**给分支命名>Finish** (**创建后自动切换到分支**)

![img](d:\pic-md/20220122134253.jpg) 
...
![img](d:\pic-md/20220122134259.jpg) 

**4.2**  **然后下一步>>然后(没截图)push**

![img](d:\pic-md/20220122134305.jpg) 

4.3 等待一会儿,弹出下面对话窗口说明成功了

![img](d:\pic-md/20220122134311.jpg) 
...
![img](d:\pic-md/20220122134319.jpg) 

 

![img](d:\pic-md/20220122134325.jpg) 

 

![img](d:\pic-md/20220122134332.jpg) 

**o6**切换分支审查代码:**项目右键>Team>Switch To > Other**

![img](d:\pic-md/20220122134343.jpg) 

**o7** 选择分支

![img](d:\pic-md/20220122134348.jpg) 

**o8** 

![img](d:\pic-md/20220122134355.jpg) 

**o9**创建新分支,选择**Check out new** **branch**为**检出**远程新分支**

![img](d:\pic-md/20220122134403.png) 

**o10**切换回 master 

![img](d:\pic-md/20220122134410.jpg) 

**o11**合并分支

![img](d:\pic-md/20220122134426.jpg) 

![img](d:\pic-md/20220122134431.jpg) 

 

**合并结果**

![img](d:\pic-md/20220122134438.jpg) 
...
![img](d:\pic-md/20220122134446.png) 
