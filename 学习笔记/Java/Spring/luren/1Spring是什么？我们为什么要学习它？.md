...
[30、jdk动态代理和cglib代理](http://www.itsoku.com/course/5/112)
...
整个spring系列使用官方最新版本5.2.3.RELEASE，会有大量案例，都是通过maven来管理的，所以maven是必备技能，对这块不熟悉的可以去看一下：[Maven系列](http://www.itsoku.com/course/2)
