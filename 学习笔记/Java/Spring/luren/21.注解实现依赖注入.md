...
# 注解实现依赖注入（@Autowired、@Resource、@Primary、@Qulifier）
...
![](assets/1641958636-da72b215b7d563eb2ea75d05b156fe43.jpg)

#### @Autowired标注在方法上或者方法参数上面：假定参数类型为为一个自定义的普通的类型，候选者查找过程如下：

![](assets/1641958636-37e19502c7a2093c9c91a8f8ab03eadd.jpg)
...
![](assets/1641958636-c71269e413afc38118fbe08bc0fa8aae.jpg)

#### @Autowired标注在方法上或者方法参数上面：假定参数类型为为一个自定义的普通的类型，候选者查找过程如下：

![](assets/1641958636-9cfe3a12bfac39b6e5f503af6ea520d1.jpg)
