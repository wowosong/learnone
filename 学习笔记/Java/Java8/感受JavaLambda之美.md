...
![image-20211210195601838](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061248876.png)
...
**`stream`和`parallelStream`的简单区分：** `stream`是顺序流，由主线程按顺序对流执行操作，而`parallelStream`是并行流，内部以多线程并行执行的方式对流进行操作，但前提是流中的数据处理没有顺序要求。例如筛选集合中的奇数，两者的处理不同之处：![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061248233.webp)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061248779.png)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061249759.webp)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061249040.png)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061249764.webp)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061249255.png)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061249566.webp)
...
![图片](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061250002.webp)
