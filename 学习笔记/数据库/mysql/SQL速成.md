...
### SQL 语法结构
 ...
 ![image-20210611171143536](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311062226219.png)
...
- **内部查询首先在其父查询之前执行，以便可以将内部查询的结果传递给外部查询。执行过程可以参考下图**：
  ...
  ![image-20210611171259888](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311062226424.png)
...
- `WHERE` 子句用于过滤记录，即缩小访问数据的范围。用于在最后的结果集中按照where条件进行过滤
...
> 
![image-20210611171405080](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311062226478.png)
