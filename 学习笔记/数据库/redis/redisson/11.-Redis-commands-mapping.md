...
SETNX|RBucket.<br/>trySet()<br/>trySetAsync()|RBucketReactive.<br/>trySet()|RBucketRx.<br/>trySet()|
...
WAIT|BatchOptions.<br/>syncSlaves()|BatchOptions.<br/>syncSlaves()|BatchOptions.<br/>syncSlaves()|
ZADD|RScoredSortedSet.<br/>add()<br/>addAsync()|RScoredSortedSetReactive.<br/>add()|RScoredSortedSetRx.<br/>add()|
