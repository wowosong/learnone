...
![image-20220728173506565](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752833.png)
...
![image-20220728173551080](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752225.png)
...
![image-20220728173339716](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752155.png)

```sql
 mysql> EXPLAIN select * from employees where id > 90000 limit 5; 
```

![image-20220728173421323](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752292.png)

显然改写后的 SQL 走了索引，而且扫描的行数大大减少，执行效率更高。

但是，这条改写的SQL 在很多场景并不实用，因为表中可能某些记录被删后，主键空缺，导致结果不一致，如下图试验所示（先删除一条前面的记录，然后再测试原 SQL 和优化后的 SQL）：

![image-20220728173158680](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752653.png)
...
![image-20220728173046775](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752928.png)

```sql
mysql> EXPLAIN select * from employees ORDER BY name limit 90000,5; 
```

![image-20220728173016817](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752665.png)
...
![image-20220728172949239](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752840.png)

需要的结果与原 SQL 一致，执行时间减少了一半以上，我们再对比优化前后sql的执行计划：

![image-20220728172917688](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752168.png)
...
![image-20220728172835895](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752666.png)从执行计划中可以看到这些信息：
...
![image-20220728172807773](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061752401.png)
...
![image-20220728172704262](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061753716.png)
...
![image-20220728172633749](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061753543.png)
