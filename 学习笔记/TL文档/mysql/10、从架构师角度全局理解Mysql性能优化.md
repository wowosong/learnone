...
MySQL性能优化其实是个很大的课题，在优化上存在着一个调优金字塔的说法：    ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800269.png)
...
*永久地修改IO调度算法,需要修改内核引导参数*   ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800616.png)
...
```
​	![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800169.png)

开启：

set GLOBAL slow_query_log=1;

 ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800860.png)
...
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800063.png)
...
```
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800461.png)
...
```
​	![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800898.png)

### **慢查询解读分析**
#### **日志格式**

开启慢查询功能以后，会根据我们的配置产生慢查询日志   
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800342.png)
...
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061800923.png)

 **./mysqldumpslow -s t -t 10 /home/mysql/mysql57/data/iZwz9j203ithc4gu1uvb2wZ-slow.log -g select**

![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801413.png)
...
换句话说，是时候回头看看我们前面讨论的内容了:MySQL执行一个查询的过程。根据下图，我们可以看到当向MySQL发送一个请求的时候，MySQL 到底做了些什么:
   ...
   ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801498.png)
...
![i](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801179.png)
...
**select @@have_profiling;**
   ...
   ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801045.png)
...
​	**set profiling=1**;
   ...
   ![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801242.png)
...
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801345.png)
...
![img](https://learnone.oss-cn-beijing.aliyuncs.com/pic/202311061801964.png)
